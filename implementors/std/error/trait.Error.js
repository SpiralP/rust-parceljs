...
implementors["actix_http"] = [{"text":"impl Error for ParseError","synthetic":false,"types":[]},{"text":"impl Error for Error","synthetic":false,"types":[]}];
implementors["actix_threadpool"] = [{"text":"impl&lt;E:&nbsp;Debug&gt; Error for BlockingError&lt;E&gt;","synthetic":false,"types":[]}];
implementors["actix_utils"] = [{"text":"impl&lt;T:&nbsp;Any&gt; Error for SendError&lt;T&gt;","synthetic":false,"types":[]}];
...
implementors["trust_dns_proto"] = [{"text":"impl Error for SslErrorStack","synthetic":false,"types":[]},{"text":"impl Error for Unspecified","synthetic":false,"types":[]}];
